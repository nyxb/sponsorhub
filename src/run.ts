...
import type { SponsorhubConfig, Sponsorship } from './types'
...
export async function run(inlineConfig?: SponsorhubConfig, t = consola) {
...
export async function defaultComposer(composer: SvgComposer, sponsors: Sponsorship[], config: SponsorhubConfig) {
