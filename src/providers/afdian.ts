...
import type { Provider, SponsorhubConfig, Sponsorship } from '../types'
...
export async function fetchAfdianSponsors(options: SponsorhubConfig['afdian'] = {}): Promise<Sponsorship[]> {
   const {
      userId,
      token,
      exechangeRate = 6.5,
