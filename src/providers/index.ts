import type { Provider, ProviderName, SponsorhubConfig } from '../types'
...
export function guessProviders(config: SponsorhubConfig) {
...
export async function fetchSponsors(config: SponsorhubConfig) {
