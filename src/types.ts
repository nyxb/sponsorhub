...
export interface Provider {
   name: string
   fetchSponsors: (config: SponsorhubConfig) => Promise<Sponsorship[]>
}
...
export interface SponsorhubConfig extends ProvidersConfig {
   /**
    ...
    * Compose the SVG
    */
   customComposer?: (composer: SvgComposer, sponsors: Sponsorship[], config: SponsorhubConfig) => PromiseLike<void> | void
...
export interface Tier {
    ...
    */
   compose?: (composer: SvgComposer, sponsors: Sponsorship[], config: SponsorhubConfig) => void
   /**
    * Compose the SVG before the main composer.
    */
   composeBefore?: (composer: SvgComposer, tierSponsors: Sponsorship[], config: SponsorhubConfig) => void
   /**
    * Compose the SVG after the main composer.
    */
   composeAfter?: (composer: SvgComposer, tierSponsors: Sponsorship[], config: SponsorhubConfig) => void
}
